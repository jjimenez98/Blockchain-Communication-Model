            ...
            if msg!=socket.error:
                ...
                if msg[0] == "promise":
                    ...
                    if promise_acks == 2 and promise_acks < 3:
                        ...
                        print("hash(transaction||Nonce||hash(n-1)) : ",block_hash.hexdigest())
                        m = hashlib.sha256(x)
                ...
                if msg[0] == "accepted":
                    ...
                    if accepted_acks == 2 and accepted_acks < 3:
...
while(1):
    ...
    if x == '2':
        ...
        if(d=='2'):
            d2 = input("\n what link to deactivate 2 , 3 , 4 , 5 : ")
            if(d2=='1'):
                active1 = False
            if(d2=='2'):
                active2 = False
